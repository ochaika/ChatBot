...
public class BookingPage extends ParentPage {
    ...
    @FindBy(xpath = ".//*[contains(@class,'user_access_signup_menu')]//form[contains(@class, 'user_access_form_signup')]//input[@name='username']")
...
//    private WebElement inputElement;
    ...
    @FindBy(xpath = ".//*[contains(@class,'user_access_signup_menu')]//form[contains(@class, 'user_access_form_signup')]//input[@type='submit']")
